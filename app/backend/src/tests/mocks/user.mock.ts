...
export const token = {
  "token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImFkbWluQGFkbWluLmNvbSIsImlhdCI6MTY5MzI1Mzc1MywiZXhwIjoxNjkzMzQwMTUzfQ.WwPzsrbpspvOWbfet6B3HfWT3_Z_1a6mi-Sa32hRWu0"
}
